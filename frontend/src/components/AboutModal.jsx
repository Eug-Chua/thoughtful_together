...
function AboutModal({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      <div className="glass-card gradient-border rounded-2xl p-8 max-w-md w-full max-h-[80vh] overflow-y-auto animate-fade-in relative">
        {/* Close button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 w-8 h-8 rounded-full bg-white/5 hover:bg-white/10 text-text-secondary hover:text-text-primary transition-all duration-200 flex items-center justify-center text-lg"
          aria-label="Close"
        >
          &times;
        </button>
        ...
        <div className="space-y-6 text-text-primary">
          ...
          <div className="text-center space-y-2">
            <h2 className="text-2xl font-semibold bg-gradient-to-r from-violet-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent">
          ...
          <div className="space-y-3">
            <p className="font-medium text-center text-sm uppercase tracking-wide text-text-secondary">How to play</p>
          ...
          <div className="pt-4 relative">
            ...
            <p className="text-center mt-4 font-medium bg-gradient-to-r from-violet-400 to-cyan-400 bg-clip-text text-transparent">
